...
@section('content')
    ...
    <form action="{{ route('users.update', ['user_id'=> $data->user_id]) }}" method="post" class="row" enctype="multipart/form-data">
        @csrf
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 col-sm-8">{{ old('user_id') }}</div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <input type="text" name="dni" value="{{ old('dni', $data->dni) }}" placeholder="@lang('translation.dni')" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-2 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <input type="text" name="name" value="{{ old('name', $data->name) }}" placeholder="@lang('translation.name')" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-2 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <input type="text" name="last_name_1" value="{{ old('last_name_1', $data->last_name_1) }}" placeholder="@lang('translation.last_name_1')" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-2 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <input type="text" name="last_name_2" value="{{ old('last_name_2', $data->last_name_2) }}" placeholder="@lang('translation.last_name_2')" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="border row mb-3 py-3">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <select class="form-control select2" name="company_id" onchange="get_locations(this.value)" required>
                                    ...
                                    @foreach ($activeCompany as $r)
                                        <option value="{{ $r->company_id }}" {{ old('company_id', $data->company_id) == $r->company_id ? 'selected' : '' }}>{{ $r->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <select class="form-control select2" name="role_id" required>
                                    ...
                                    @foreach ($activeRoles as $r)
                                        <option value="{{ $r->role_id }}" {{ old('role_id', $data->role_id) == $r->role_id ? 'selected' : '' }}>{{ $r->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-check form-check-outline form-check-success mb-3">
                                    <input class="form-check-input" name="have_same_role" value="1" {{ old('have_same_role') == '1' ? 'checked' :'' }} onchange="toggleStoreRoles()" type="checkbox" id="formCheck15">
                        ...
                        <div class="store-roles-container">
                            ...
                            @foreach ($data->user_stores as $l)
                            <div class="row mb-3">
                                <div class="col-lg-2 col-md-6">{{ $l->location_name }}</div>
                                <div class="col-lg-4 col-md-6">
                                    <select class="form-control select2 store-roles" name="roles[{{ $l->location_id }}]" required>
                                        <option value="">@lang('translation.choose_role')</option>
                                        @foreach ($activeRoles as $r)
                                            <option value="{{ $r->role_id }}" 
                                                {{ @old('roles')[$l->location_id] == $r->role_id ? 'selected' : '' }}
                                                {{ $l->role_id == $r->role_id ? 'selected' : '' }}
                                                >
                                                {{ $r->name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="form-check form-check-outline form-check-success mb-3">
                                        <input class="form-check-input" name="default_store" value="{{ $l->location_id }}" type="radio" id="formCheck{{ $r->role_id }}" {{ ( $l->default_store == '1' ) ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <input type="text" name="phone" value="{{ old('phone', $data->phone) }}" placeholder="@lang('translation.phone')" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-2 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <input type="email" name="email" value="{{ old('email', $data->email) }}" placeholder="@lang('translation.email')" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-2 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <input type="password" name="key" value="{{ old('key', $data->key) }}" maxlength="4" pattern="[0-9]{4}" title="@lang('translation.please_enter_4_digit_pin')" placeholder="@lang('translation.key')" class="form-control mb-1" required>
                    ...
                    <div class="form-check form-switch form-switch-right form-switch-md">
                        ...
                        <input name="status" value="1" {{ old('status', $data->status)=='0' ? '' :'checked' }} class="form-check-input code-switcher" type="checkbox" id="statusSwitch">
                    </div>
