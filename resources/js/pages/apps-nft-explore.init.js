...
/*********************
    range-product-price
**********************/
var rangeProductLocation = document.getElementById('range-product-price');

noUiSlider.create(rangeProductLocation, {
...
mergeTooltips(rangeProductLocation, 5, ' - ');
...
rangeProductLocation.noUiSlider.on('change', function (values, handle) {
